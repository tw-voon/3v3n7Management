                        ...
                        <div class="auth-box">
                            ...
                            <div class="row m-b-20">
                                <div class="col-md-12 col-12">
                                    <h3 class="text-center txt-primary">You have successfully change your password</h3>
                                </div>
                            </div>
                            <p class="text-inverse b-b-default text-left p-b-5">Please back to login page and login with your new password</p>
                            ...
                            <div class="row m-t-30">
                                <div class="col-md-12">
                                    <a type="submit" href="{{ url('/login') }}" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Back to login</a>
                                </div>
                            </div>
