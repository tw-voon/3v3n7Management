...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <h1 class="size-48" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 36px;line-height: 43px;font-family: avenir,sans-serif;text-align: center;" lang="x-size-48"><span class="font-avenir"><font color="#ffffff"><strong>Event Management</strong></font></span></h1>
      </div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 50px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <p class="size-16" style="Margin-top: 0;Margin-bottom: 20px;font-size: 16px;line-height: 24px;" lang="x-size-16"><span style="color:#000000"><strong>Hello !</strong></span></p>
      </div>
    </div>
        
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <p style="Margin-top: 0;Margin-bottom: 20px;">You are receiving this email because we noticed that you have a coming event as stated below:</p>
      </div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        ...
        <p style="Margin-top: 0;Margin-bottom: 0; color: black;">Event Title : {{$item->title}}</p>
        <p style="Margin-top: 20px;Margin-bottom: 0; color: black;">Start Time: {{$item->start_time}}</p>
        <p style="Margin-top: 20px;Margin-bottom: 0; color: black;">End Time : {{$item->end_time}}</p>
        <p style="Margin-top: 20px;Margin-bottom: 0; color: black;">Location : {{$item->location}}</p>
        <p style="Margin-top: 20px;Margin-bottom: 0; color: black;">Address : {{$item->address}}</p>
            ...
            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                ...
                <div style="font-size: 12px;line-height: 19px;">
                  <div>Kuching IT Solution - Event Management Team</div>
                </div>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 18px;">
                  <div>You are receiving this email because this is a friendly reminder for the coming event</div>
                </div>
                <!--[if mso]>&nbsp;<![endif]-->
              </div>
            </div>
